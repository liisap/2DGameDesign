...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Makes sure char is on the groud by checking the distance from char downwards
        RaycastHit2D hit = Physics2D.Raycast(transform.position, Vector2.down, groundCheckDistance);
        //if there is ground close enough you aren't i nthe air
        inAir = hit.collider == null;

        //if the char is on the ground and "jump" space abr is pushed the char jumps
